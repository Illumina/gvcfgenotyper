...
static void usage(){
    ...
    std::cerr << "    -O, --output-type <b|u|z|v>       b: compressed BCF, u: uncompressed BCF, z: compressed VCF, v: uncompressed VCF [v]" << std::endl;
    std::cerr << "    -r, --regions     <region>        region to genotype eg. chr1 or chr20:5000000-6000000" << std::endl;
...
int main(int argc,char **argv)
{
	...
	switch (c)
	{
	case 'l': gvcf_list = optarg; break;
	case 'f': reference_genome = optarg; break;
	case 'o': output_file = optarg; break;
	case 'O': output_type = optarg;break;
